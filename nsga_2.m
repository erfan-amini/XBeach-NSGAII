function chromosome = nsga_2(pop,gen,M, V, min_range, max_range,wave_power,Dataset)
...
chromosome = initialize_variables_Line70(pop, M, V, min_range, max_range, wave_power,Dataset);
...
for i = 1 : gen
    ...
    offspring_chromosome = ...
        genetic_operator_Line114_150(parent_chromosome, ...
        M, V, mu, mum, min_range, max_range, wave_power, Dataset);
